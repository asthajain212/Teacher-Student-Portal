 ...
 * @author Lenovo
 */
public class cse3108 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MARK OF CSE 3108 (Microprocessor Lab)");
    ...
    private void detailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailsActionPerformed
        ...
        detailMarkcse3108 d = new detailMarkcse3108();
        d.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cse3108.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
