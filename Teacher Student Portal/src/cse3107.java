 ...
 * @author Lenovo
 */
public class cse3107 extends javax.swing.JFrame {

    /**
     * Creates new form cse3107
     */
    private static int quiz,attendance,Final;
    
    public cse3107() {
        initComponents();
    }

    public void funcCse3107(String Id,int Mark,String Grade,double Gpa,int quiz1,int attendance1,int Final1){
        
        //System.out.println("hello from shohag");
        ...
        System.out.println("atten: "+attendance);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MARK OF CSE 3107 (Microprocessor)");
    ...
    private void detailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailsActionPerformed
        ...
        detailMarkcse3107 d = new detailMarkcse3107();
        d.setVisible(true);
        d.setDetail(quiz,attendance,Final);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cse3107.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
