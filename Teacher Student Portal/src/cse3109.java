 ...
 * @author Lenovo
 */
public class cse3109 extends javax.swing.JFrame {
    ...
    public void funcCse3109(String Id,int Mark,String Grade,double Gpa,int quiz1,int attendance1,int Final1){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MARK OF CSE 3109 (Digital System Design)");
    ...
    private void detailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailsActionPerformed
        ...
        detailMarkcse3109 d = new detailMarkcse3109();
        d.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cse3109.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
