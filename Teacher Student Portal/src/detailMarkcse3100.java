 ...
 * @author Lenovo
 */
public class detailMarkcse3100 extends javax.swing.JFrame {

    /**
     * Creates new form detailMarkcse3100
     */
    public detailMarkcse3100() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Detail Marks Of CSE3100");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detailMarkcse3100.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new detailMarkcse3100().setVisible(true);
            }
        });
    }
