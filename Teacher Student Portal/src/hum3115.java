 ...
 * @author Lenovo
 */
public class hum3115 extends javax.swing.JFrame {
    
    static int quiz,attendance,Final;
    
    public void funcHum3115(String Id,int Mark,String Grade,double Gpa,int quiz1,int attendance1,int Final1){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MARK OF HUM3115 (Economics)");
    ...
    private void detailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailsActionPerformed
        ...
        detailMarkhum3115 d = new detailMarkhum3115();
        d.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hum3115.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
