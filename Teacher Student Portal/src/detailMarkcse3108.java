 ...
 * @author Lenovo
 */
public class detailMarkcse3108 extends javax.swing.JFrame {

    
    public detailMarkcse3108() {
        initComponents();
    }
   ...
   static int attendance1,online1,offline1,mid1,project1;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Detail Marks Of CSE3108");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detailMarkcse3108.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new detailMarkcse3108().setVisible(true);
            }
        });
    }
