 ...
 * @author Lenovo
 */
public class cse3104 extends javax.swing.JFrame {
    ...
    public void funcCse3104(String Id,int Mark,int attendance,int online,int offline,int mid,int project,String Grade,double Gpa){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MARK OF CSE 3104 (Database Lab)");
    ...
    private void detailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailsActionPerformed
        ...
        detailMarkcse3104 d = new detailMarkcse3104();
        d.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cse3104.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
