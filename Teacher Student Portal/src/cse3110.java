 ...
 * @author Lenovo
 */
public class cse3110 extends javax.swing.JFrame {
    ...
    public void funcCse3108(String Id,int Mark,int attendance,int online,int offline,int mid,int project,String Grade,double Gpa){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MARK OF CSE 3110 (Digital System Design Lab)");
    ...
    private void detailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailsActionPerformed
        ...
        detailMarkcse3110 d = new detailMarkcse3110();
        d.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cse3110.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
